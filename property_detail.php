...
<body>
    ...
    <div class="property-summary page-container">
        ...
        <div class="row no-gutters">
            ...
            <div class="button-container col-6">
                ...
                <!-- <a href="includes/login_modal.php" class="btn btn-primary">Book Now</a> -->
                <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#booking-modal">
    ...
    <?php
    include "includes/booking_modal.php";
